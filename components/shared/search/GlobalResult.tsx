...
const GlobalResult = () => {
  ...
  // render link if user click on result
  ...
  return (
    <div className="absolute top-full z-10 mt-4 w-full rounded-xl bg-light-800 py-5 shadow-sm dark:bg-dark-400">
